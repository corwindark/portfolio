...
from statsforecast.models import AutoCES, AutoARIMA
import numpy as np
import time
```
...
# Auto Arima
crossValidation(seriesTrain, tempTest, 3, testResultsDF, 'auto_arima', aaPredFunction)

crossValidation(seriesTrain, tempTest, 3, testResultsDF, 'complex_smoothing', cesPredFunction)


"""
working CES save
model = AutoCES()
fit1 = model.fit(y = np.concatenate(seriesTrain.to_numpy()))
prediction = fit1.predict(2)
print(prediction.get('mean'))
